...
import com.xx.api.business.product.*;
...
public class ProductBusinessServiceImpl implements ProductBusinessService {
    private static final Logger LOG = LoggerFactory.getLogger(ProductBusinessServiceImpl.class);
    private final ServiceUtil serviceUtil;
    private  ProductBusinessIntegration integration;

    public ProductBusinessServiceImpl(ServiceUtil serviceUtil, ProductBusinessIntegration integration) {
        this.serviceUtil = serviceUtil;
        this.integration = integration;
    }

    @Override
    public void createBusinessProduct(ProductAggregate body) {
        try {
